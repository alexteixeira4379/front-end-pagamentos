  ...
  <div class="box">
    ...
    <div class="box__description">
      <div class="box__description-container">
        <div class="box__description-title">{{ $t('_404.title') }}</div>
        <div class="box__description-text">{{ $t('_404.description') }}</div>
      </div>

      <a href="/" target="_blank" class="box__button">{{ $t('_404.button') }}</a>
